...
def main(config: Config) -> None:
    ...
    metrics = dict.fromkeys(["iteration", "qd_score", "coverage", "max_fitness", "qd_score_repertoire", "dem_repertoire", "q_actor_fitness", "d_actor_fitness", "ga_offspring_added", "qpg_offspring_added", "dpg_offspring_added", "time"], jnp.array([]))
    ...
    for i in range(num_loops):
        ...
        current_metrics["ga_offspring_added"], current_metrics["qpg_offspring_added"], current_metrics["dpg_offspring_added"] = get_n_offspring_added(current_metrics)
