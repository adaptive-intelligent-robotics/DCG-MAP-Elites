...
from qdax.core.neuroevolution.losses.td3_ablation_3_loss import make_td3_ablation_3_loss_fn
...
class Ablation3Emitter(Emitter):
    """
    ...
    def __init__(
        ...
        self._policy_loss_fn, self._policy_dc_loss_fn, self._critic_dc_loss_fn = make_td3_ablation_3_loss_fn(
    ...
    def _train_critics(self, emitter_state: DCGMEEmitterState) -> DCGMEEmitterState:
        ...
        samples = samples.replace(rewards=similarity(
            samples.desc, samples.input_desc, self._config.lengthscale)*samples.rewards)
