...
class PGAMEEmitter(Emitter):
    ...
    def emit(
        ...
        x1, _, random_key = repertoire.sample(random_key, mutation_ga_batch_size)
        x2, _, random_key = repertoire.sample(random_key, mutation_ga_batch_size)
        ...
        x1, _, random_key = repertoire.sample(random_key, mutation_pg_batch_size)
        mutation_fn = partial(
